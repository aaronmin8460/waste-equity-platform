...
export default function MapLegendOverlay(props: MapLegendOverlayProps) {
  return (
    ...
    <details
      className="map-legend w-[min(86vw,288px)] overflow-hidden rounded-card border border-hairline-strong bg-white/90 text-ink-muted shadow-float backdrop-blur-sm"
