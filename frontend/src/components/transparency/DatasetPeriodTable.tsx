      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[720px] text-left text-sm">
          ...
          <thead>
            ...
            <tr className="border-b-2 border-primary text-xs font-bold text-ink-subtle">
          ...
          <tbody>
            {rows.map((row) => (
              <tr key={row.name} className="border-b border-hairline align-top last:border-b-0">
                <th scope="row" className="py-3 pr-3 text-left text-base font-bold text-ink">
                  {row.name}
                  {row.note ? (
                ...
                <td className="py-3 pr-3 tabular-nums text-ink-muted">{row.referencePeriod}</td>
                ...
                <td className="py-3 pr-3 tabular-nums text-ink-muted">{formatCount(row.count)}</td>
                <td className="py-3 pr-3 text-ink-muted">{row.coverage}</td>
              </tr>
            ))}
          </tbody>
        </table>
