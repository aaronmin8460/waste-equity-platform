 ...
 * the searchable service-region picker in Phase 2 and the transparency dataset status
 * badge in Phase 6. The equity region comparison was listed here too, until the
 * correction pass replaced that card with the full ranking dialog.
 *
