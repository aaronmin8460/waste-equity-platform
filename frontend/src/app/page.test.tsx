...
vi.mock("../lib/api", async (importOriginal) => {
  ...
  return {
    ...
    fetchSuitabilityPolicy: vi.fn().mockResolvedValue({
      ...
      data_derived_profiles: { critic: { method: "CRITIC" } },
    ...
    fetchSuitabilityLatestRun: vi.fn().mockResolvedValue({
      ...
      weight_derivation: { method: "CRITIC", population_candidate_count: 1099, zero_variance_criteria: [] },
      stability_definition: { top_cutoff_rank: 110, top_fraction: "0.10" },
    ...
    fetchSuitabilitySummary: vi.fn().mockResolvedValue({
      ...
      stability_definition: { top_cutoff_rank: 110 },
